...
const App: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className={`min-h-screen bg-slate-950 text-slate-200 selection:bg-brand-500 selection:text-white font-sans overflow-x-hidden transition-opacity duration-1000 ${isLoading ? 'h-screen overflow-hidden' : ''}`}>
